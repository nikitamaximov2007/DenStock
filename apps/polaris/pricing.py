...
def customer_price_rub(wholesale_price_usd, usd_rate, markup_percent):
    """Return whole-ruble customer price or None when wholesale price is absent."""
...
def current_customer_price_rub(wholesale_price_usd):
    ...
    return customer_price_rub(
        wholesale_price_usd, valuation.current_usd_rate, settings.polaris_markup_percent
    )
