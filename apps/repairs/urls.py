...
urlpatterns = [
    ...
    path(
        "orders/<int:pk>/add-oil-lot/",
        views.repair_order_add_oil_lot,
        name="repair_order_add_oil_lot",
    ),
    ...
    path("lines/<int:pk>/cancel/", views.repair_line_cancel, name="repair_line_cancel"),
    path(
        "orders/<int:pk>/cancel/confirm/", views.repair_order_cancel_confirm,
        name="repair_order_cancel_confirm",
    ),
    path(
        "lines/<int:pk>/price/",
