...
ALL_CAPABILITIES = frozenset(
    {MANAGE_USERS, MANAGE_DIRECTORIES, VIEW_FINANCE, VIEW_PURCHASE_COST, EDIT, CONFIRM_ADJUSTMENTS}
)

# --- Карта «роль → возможности» ---
ROLE_CAPABILITIES = {
    ADMIN: {
        MANAGE_USERS, MANAGE_DIRECTORIES, VIEW_FINANCE, VIEW_PURCHASE_COST,
        EDIT, CONFIRM_ADJUSTMENTS,
    },
    MANAGER: {MANAGE_DIRECTORIES, VIEW_FINANCE, VIEW_PURCHASE_COST, EDIT, CONFIRM_ADJUSTMENTS},
    STOREKEEPER: {EDIT},
    SELLER: {EDIT},
