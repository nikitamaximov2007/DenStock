...
ALL_CAPABILITIES = frozenset(
    {MANAGE_USERS, VIEW_FINANCE, VIEW_PURCHASE_COST, EDIT, CONFIRM_ADJUSTMENTS}
)

# --- Карта «роль → возможности» ---
ROLE_CAPABILITIES = {
    ADMIN: {MANAGE_USERS, VIEW_FINANCE, VIEW_PURCHASE_COST, EDIT, CONFIRM_ADJUSTMENTS},
    MANAGER: {VIEW_FINANCE, VIEW_PURCHASE_COST, EDIT, CONFIRM_ADJUSTMENTS},
    STOREKEEPER: {EDIT},
    SELLER: {EDIT},
