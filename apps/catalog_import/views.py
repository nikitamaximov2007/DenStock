...
SUMMARY_ROWS = (
    ...
    ("new_file_nonzero_price", "Цена из нового файла"),
    ("same_file_nonzero_fallback", "Цена из другой строки нового файла"),
    ("previous_catalog_price_retained", "Сохранена цена предыдущего каталога"),
    ("no_usable_price", "Цена не указана ни в одном источнике"),
    ("ambiguous_nonzero_wholesale", "Неоднозначных ненулевых цен"),
    ("conflicting_nonzero_wholesale", "Разных ненулевых цен в дубликатах"),
    ("invalid_wholesale_price", "Некорректных оптовых цен"),
    ("negative_wholesale_price", "Отрицательных оптовых цен"),
