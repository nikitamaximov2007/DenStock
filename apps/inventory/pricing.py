...
def resolve_effective_inventory_customer_price(inventory):
    ...
    """
    current = inventory.part_type.recommended_price
    ...
    valid = [value for value in (current, snapshot) if isinstance(value, Decimal) and value >= 0]
