...
CUSTOMER_OPERATOR_CONTEXT_TTL_MINUTES = env.int(
    "CUSTOMER_OPERATOR_CONTEXT_TTL_MINUTES", default=30
)
CUSTOMER_OPERATOR_PHOTO_CONTEXT_TTL_MINUTES = env.int(
    "CUSTOMER_OPERATOR_PHOTO_CONTEXT_TTL_MINUTES", default=5
)
